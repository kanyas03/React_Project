...
function SignUp() {
    ...
    return (
        <div className="bg-indigo-950  fixed">
    ...
    <div  className="mt-[50px] md:ml-[100px]">
     <h1 className=" mt-[10px] md:pl-[100px] pl-2 md:text-4xl text-2xl text-white font-extrabold">Sign Up</h1>
      {error && <p className='text-red-500 mb-4'>{error}</p>}
        ...
        <input type="text" className="md:w-[350px] w-[200px] bg-white hover:border-2 border-black"  
        ...
        <input type="Number" className="md:w-[350px] w-[200px] bg-white hover:border-2 border-black" 
        ...
        <input type="password" className="md:w-[350px] w-[200px] bg-white hover:border-2 border-black" 
